...
```javascript
import T from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-t-ctor@v0.2.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dists-t-ctor/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/stats-base-dists-t-ctor/actions/workflows/test.yml?query=branch:v0.2.0
